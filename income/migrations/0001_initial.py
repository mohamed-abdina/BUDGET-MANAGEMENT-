    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#1D8763', max_length=7)),
                ('icon', models.CharField(default='ti-cash', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='incomes', to='income.incomecategory')),
            ],
            options={
                'db_table': 'incomes',
